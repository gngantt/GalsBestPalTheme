    ...
    <div class="row justify-content-center align-items-center">
        <div class="col-sm-12 col-md-8">
            <p class="text py-3">
                ...
                <a href="https://blog.cuddly.com/pet-health-wellness/decompression-the-3-3-3-rule/">Decompression Phase</a></br>
    ...
    <div class="row justify-content-center align-items-center">
        <div class="col-sm-12 col-md-8">
            ...
            <p class="text py-3">
				...
				<a href="https://galsbestpal.com/wp-content/uploads/2022/07/The-best-way-to-handle-problem-behaviors-is-to-not-let-them-start.pdf">	Tips We've Found Along the Way</a></br>
